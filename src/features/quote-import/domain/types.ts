...
export const MAPPING_FIELDS = ['quote_reference','quote_date','customer_display_name','customer_phone','customer_email','registration_number','vin','brand','model','mileage','insurer_name','expert_name','claim_reference','coverage_type','line_reference','line_label','operation_code','quantity','unit','labor_hours','category','stage','notes'] as const;
